...
class GuignaAppDelegate: NSObject, GAppDelegate, NSApplicationDelegate, NSMenuDelegate, NSOutlineViewDelegate, NSOutlineViewDataSource, NSTableViewDelegate, NSTableViewDataSource, NSTextViewDelegate {
    ...
    func applicationDidFinishLaunching(_ aNotification: Notification) {
        ...
        scrapes += [PkgsrcSE(agent: agent), Freecode(agent: agent), /* Debian(agent: agent), CocoaPods(agent: agent), */ PyPI(agent: agent), RubyGems(agent: agent), MacUpdate(agent: agent), AppShopper(agent: agent), AppShopperIOS(agent: agent), MacTorrents(agent: agent), Chocolatey(agent: agent)]
